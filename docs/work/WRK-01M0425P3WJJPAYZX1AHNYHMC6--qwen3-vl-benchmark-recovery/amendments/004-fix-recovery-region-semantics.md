# Amendment: fix transform region semantics

Page-level Qwen text without coordinates must remain page-level transform data,
...
regions and original-source assets. Transform JSON must expose page-level text
