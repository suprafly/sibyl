...
pass. Page transform remains responsible for page-level text and must not
...
cropped from the original source. Page transform and drawing localization remain
